...
@section('title', 'Jadwal Sholat - Masjid Al Muta\'allimin')
...
<section class="hero-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-4 fw-bold mb-4">Jadwal Sholat Hari Ini</h1>
                @if($prayerTime)
                    <p class="lead">{{ $prayerTime->location }} - {{ Carbon::parse($prayerTime->date)->format('l, d F Y') }}</p>
                @endif
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card card-custom h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted mb-0">Jadwal sholat di atas menggunakan waktu setempat (WIB) untuk wilayah Cilegon, Banten.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-custom h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted mb-0">Jadwal sholat diperbarui setiap hari sesuai dengan perhitungan astronomi yang akurat.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-custom h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted mb-0">Masjid Al Muta'allimin berlokasi di Fakultas Teknik Universitas Sultan Ageng Tirtayasa.</p>
                    </div>
                </div>
            </div>
        </div>
