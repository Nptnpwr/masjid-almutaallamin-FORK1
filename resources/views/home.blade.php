...
@section('title', 'Beranda - Masjid Al Muta\'allimin')
...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="https://images.unsplash.com/photo-1591604466107-ec97de577aff?w=1200" class="d-block w-100" alt="Masjid 1">
        ...
        <div class="carousel-item">
            <img src="https://images.unsplash.com/photo-1564769625905-50e93615e769?w=1200" class="d-block w-100" alt="Masjid 2">
            <div class="carousel-caption">
                <h2 class="display-5 fw-bold">Tempat Ibadah dan Pembelajaran</h2>
                <p class="lead">Masjid Al Muta'allimin Fakultas Teknik Untirta</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="https://images.unsplash.com/photo-1542816417-0983c9c9ad53?w=1200" class="d-block w-100" alt="Masjid 3">
            <div class="carousel-caption">
            ...
            @forelse($news as $item)
                <div class="col-md-4">
                    <div class="card card-custom h-100">
                        ...
                        @else
                            <div class="bg-gradient-primary" style="height: 200px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"></div>
                        @endif
                        <div class="card-body">
