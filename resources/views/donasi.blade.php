...
@section('title', 'Donasi - Masjid Al Muta\'allimin')
...
<section class="hero-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-4 fw-bold mb-4">Infaq & Donasi</h1>
                <p class="lead">Dukung program dakwah, pendidikan, dan sosial Masjid Al Muta'allimin</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-6 mx-auto">
                <div class="card card-custom">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="text-muted mb-4">Scan kode QR di bawah untuk donasi melalui aplikasi e-wallet atau m-banking</p>
                        ...
                        <a href="https://wa.me/6285891331229" 
                           target="_blank" 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-4">
                <img src="https://via.placeholder.com/300x300/667eea/ffffff?text=QRIS+CODE" 
                     alt="QRIS Code" 
