...
@section('title', 'Kegiatan - Masjid Al Muta\'allimin')
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="lead">Agenda rutin dan insidental untuk jamaah Masjid Al Muta'allimin</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0">Hubungi pengurus DKM untuk informasi lebih lanjut tentang peminjaman ruang dan fasilitas</p>
            </div>
