...
@section('title', 'Berita - Masjid Al Muta\'allimin')
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="lead">Update kabar terbaru komunitas & konten islami dari Masjid Al Muta'allimin</p>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="card-body d-flex flex-column">
                                <div class="mb-2">
                                    <small class="text-muted">
                                        <i class="bi bi-calendar3"></i><i class="bi bi-calendar3"></i> {{ $item->published_date->format('d F Y') }}
                                    </small>
                                </div>
